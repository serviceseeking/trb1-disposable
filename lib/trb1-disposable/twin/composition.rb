require "trb1-disposable/expose"
require "trb1-disposable/composition"
  ...
  module Disposable
    class Twin
      module Expose
        module ClassMethods
          def expose_class
            @expose_class ||= Class.new(Trb1::Disposable::Expose).from(definitions.values)
          end
        end # ClassMethods.
      ...
      module Composition
        module ClassMethods
          def expose_class
            @expose_class ||= Class.new(Trb1::Disposable::Composition).from(definitions.values)
          end
        end
